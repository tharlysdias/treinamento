...
export class PersonService {
  ...
  update(person: IPerson): Observable<EntityResponseType> {
    return this.http.put<IPerson>(`${this.resourceUrl}/${getPersonIdentifier(person) as string}`, person, { observe: 'response' });
  }

  partialUpdate(person: IPerson): Observable<EntityResponseType> {
    return this.http.patch<IPerson>(`${this.resourceUrl}/${getPersonIdentifier(person) as string}`, person, { observe: 'response' });
  }
