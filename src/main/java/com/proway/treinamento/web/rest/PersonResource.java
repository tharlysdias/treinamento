...
import com.proway.treinamento.repository.PersonRepository;
...
/**
 * REST controller for managing {@link com.proway.treinamento.domain.Person}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PersonResource {
    ...
    public ResponseEntity<List<Person>> getAllPeople(
        ...
        Page<Person> page;
        if (eagerload) {
            page = personRepository.findAllWithEagerRelationships(pageable);
        } else {
