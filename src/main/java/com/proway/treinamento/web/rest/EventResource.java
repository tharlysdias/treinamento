...
/**
 * REST controller for managing {@link com.proway.treinamento.domain.Event}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EventResource {
    ...
    public ResponseEntity<Event> updateEvent(@PathVariable(value = "id", required = false) final UUID id, @Valid @RequestBody Event event)
